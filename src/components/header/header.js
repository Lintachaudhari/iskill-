...
const Header = ({ siteTitle }) => (
  ...
  <Navbar.Brand ><Link to="/" style={{color: `#0c2e8a`, textDecoration: `none`,}}>
                  <img src={IskyllIcon} />
                </Link></Navbar.Brand>
  ...
  <Navbar.Collapse id="basic-navbar-nav">
    ...
    <Form >
      <button title="Sign Up" className="outline-btn">Sign Up</button>
      <button title="Sign In" className="fill-btn ml-3">Sign In</button>
    </Form>
  </Navbar.Collapse>
</Navbar>
    </div>
